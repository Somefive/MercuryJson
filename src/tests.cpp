...
void test_extract_mask() {
    ...
    prev_mask = 0;
    __mmask32 pseudo_mask1 = MercuryJson::extract_pseudo_structural_mask(
            structural_mask1, whitespace_mask1, quote_mask1, literal_mask1, prev_mask);
    __mmask32 pseudo_mask2 = MercuryJson::extract_pseudo_structural_mask(
            structural_mask2, whitespace_mask2, quote_mask2, literal_mask2, prev_mask);
...
void test_extract_warp_mask() {
    ...
    printf("escape mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(escape_mask1),
           static_cast<unsigned long long>(escape_mask2));
    prev_mask = 0;
    ...
    printf("quote mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(quote_mask1),
           static_cast<unsigned long long>(quote_mask2));
    printf("literal mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(literal_mask1),
           static_cast<unsigned long long>(literal_mask2));
    u_int64_t structural_mask1 = 0, whitespace_mask1 = 0;
    u_int64_t structural_mask2 = 0, whitespace_mask2 = 0;
    MercuryJson::extract_structural_whitespace_characters(input1, literal_mask1, structural_mask1, whitespace_mask1);
    MercuryJson::extract_structural_whitespace_characters(input2, literal_mask2, structural_mask2, whitespace_mask2);
    printf("structural mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(structural_mask1),
           static_cast<unsigned long long>(structural_mask2));
    printf("whitespace mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(whitespace_mask1),
           static_cast<unsigned long long>(whitespace_mask2));
    prev_mask = 0;
    u_int64_t pseudo_mask1 = MercuryJson::extract_pseudo_structural_mask(
            structural_mask1, whitespace_mask1, quote_mask1, literal_mask1, prev_mask);
    u_int64_t pseudo_mask2 = MercuryJson::extract_pseudo_structural_mask(
            structural_mask2, whitespace_mask2, quote_mask2, literal_mask2, prev_mask);
    printf("pseudo mask: \n%016llx\n%016llx\n", static_cast<unsigned long long>(pseudo_mask1),
           static_cast<unsigned long long>(pseudo_mask2));
